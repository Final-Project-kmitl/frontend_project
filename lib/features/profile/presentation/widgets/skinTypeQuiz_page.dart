...
//material for build page
  ...
  void _sendForm() {
    ...
    context.read<ProfileBloc>().add(UpdateSkinTypeEvent(_resultQuiz['id']));
        ...
        children: [
          ...
          SizedBox(
            ...
            child: ElevatedButton(
                style: ElevatedButton.styleFrom(
                    backgroundColor:
                        _isQuizSuccess ? AppColors.white : AppColors.grey,
                    shape: RoundedRectangleBorder(
                        side: BorderSide(
                            color: _isQuizSuccess
                                ? AppColors.black
                                : AppColors.transparent),
                        borderRadius: BorderRadius.circular(16)),
                    padding: EdgeInsets.symmetric(vertical: 16)),
                onPressed: _isQuizSuccess
                    ? () {
                        setState(() {
                          _formPageController.jumpToPage(
                            2,
                          );
                        });
                      }
                      ...
                      child: ElevatedButton(
                        ...
                        onPressed: skinTypeQuiz[_currentPage] == ""
                            ...
                            : _currentPage == 6
                                ...
                                : _nextPage,
                        child: Text(
                          _currentPage <= 5 ? 'ต่อไป' : "เสร์จสิ้น",
                          style: TextThemes.bodyBold
